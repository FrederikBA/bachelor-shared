...
public static class Config
{
    ...
    {
        public const string IntegrationClaim = "service_integration_policy";
    }
    
    public static class IntegrationEndpoints
    {
        public const string WarningSentenceIntegration = "http://localhost:5267/api/WarningSentenceIntegration/warningsentences";
    }
}